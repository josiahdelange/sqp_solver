...
class MatyasFunction: public NonlinearProblem
{
public:
    MatyasFunction()
    {
    ...
    {
        obj = 0.26*(std::pow(decision[0], 2) + std::pow(decision[1], 2)) - 
            0.48*decision[0]*decision[1];
    }
